...
| `GASP-03` | Mover-Ragdoll-Experience | **Source-Audit abgeschlossen, in Review** | Originalquellen, Inventar, RPG-Zuordnung und Erhaltungsprüfungen dokumentiert; Commit/PR offen. Begrenzter GASP-03-Pilot als nächster Teilauftrag, Variante noch nicht implementiert. [Auditbericht](gasp-mover-ragdoll-source-audit.md) |
...
Dieser Audit ist auf `codex/gasp-03-ragdoll-source-audit` abgeschlossen und in
Review; konkrete Quellbefunde und verbleibende Lücken stehen im
