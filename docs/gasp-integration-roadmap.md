...
- **Implementiert und validiert: `GASP-02` / `GASP-NET-01` – Rollback während aktivem Mantle.** Branch `codex/gasp-net-01-active-mantle-rollback`, Commit `b6709eb4`, [Draft-PR #147](https://github.com/Athurito/SurvivalRpg/pull/147); Editor-Build, 10/10 Regressionen, zusätzlicher 30-FPS-Lauf und echte Negativkontrolle. [Nachweis](gasp-active-mantle-rollback.md); Review/Merge offen.
...
| `GASP-02` | Gezielte Stabilisierung | **In Arbeit (Teilauftrag)** | `GASP-STAB-01` gemergt in PR #145; `GASP-STAB-02` gemergt in PR #146; `GASP-NET-01` implementiert/validiert, Review/Merge offen; danach `GASP-NET-02`, weitere Registerpunkte offen |
...
| `GASP-NET-01` | **PR offen**, validiert | Echten Restore/Replay samt Gegenkorrektur desselben aufgezeichneten aktiven Frames nachgewiesen, einschließlich vom Server übersprungenem Injektionsframe. Warp-/Collider-/Montagevertrag erhalten; Editor-Build, 10/10 Regressionen, 30-FPS-Fokus und erwartete negative Gegenprobe. Commit `b6709eb4`, [Draft-PR #147](https://github.com/Athurito/SurvivalRpg/pull/147); [Nachweis](gasp-active-mantle-rollback.md). |
