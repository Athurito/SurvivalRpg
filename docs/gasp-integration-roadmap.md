...
| Mover-Ragdoll | Akzeptierte Basis vor dem Pilot: unter `Mover/Ragdoll` nur die referenzierte Input-Struktur, keine abgenommene Experience/PawnData. Neue Variante derzeit in Arbeit mit Teilnachweisen, noch nicht übernommen | [Assetumfang](gasp-asset-foundation.md), [laufender Pilot](gasp-mover-ragdoll-pilot.md) |
...
| `GASP-03` | Mover-Ragdoll-Experience | **Validierung** | Source-Audit PR #151 gemergt. Pilot: Editor/Game, 20/20 Tests, Root-Sichtprüfung und Abschlussaudit bestanden. Commit/Draft-PR und manuelle Nutzer-Sichtprüfung noch offen. [Pilotbericht](gasp-mover-ragdoll-pilot.md) |
