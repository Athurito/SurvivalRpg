...
- **Implementiert und validiert: `GASP-02` / `GASP-NET-01` – Rollback während aktivem Mantle.** Branch `codex/gasp-net-01-active-mantle-rollback`, Commit `b6709eb4`; Editor-Build, 10/10 Regressionen, zusätzlicher 30-FPS-Lauf und echte Negativkontrolle. [Nachweis](gasp-active-mantle-rollback.md); Review/Merge offen.
...
| `GASP-NET-01` | **Validiert**, Review/Merge offen | Echten Restore/Replay samt Gegenkorrektur desselben aufgezeichneten aktiven Frames nachgewiesen, einschließlich vom Server übersprungenem Injektionsframe. Warp-/Collider-/Montagevertrag erhalten; Editor-Build, 10/10 Regressionen, 30-FPS-Fokus und erwartete negative Gegenprobe. Commit `b6709eb4`; [Nachweis](gasp-active-mantle-rollback.md). |
