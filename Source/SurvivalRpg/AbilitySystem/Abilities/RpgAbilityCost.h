...
#include "RpgAbilityCost.generated.h"
 ...
 * URpgAbilityCost
 *
 * Base class for costs that a RpgGameplayAbility has (e.g., ammo or charges)
 */
...
public:
	 ...
	 */
	virtual bool CheckCost(const URpgGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
	{
		return true;
	}
	 ...
	 */
	virtual void ApplyCost(const URpgGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
	{
	}
