...
URpgGameplayAbility_Interact::URpgGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void URpgGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
{
	if (ARpgPlayerController* PC = GetRpgPlayerControllerFromActorInfo())
	{
		if (URpgIndicatorManagerComponent* IndicatorManager = URpgIndicatorManagerComponent::GetComponent(PC))
		{
