...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Visual", meta = (AllowPrivateAccess = "true", ToolTip = "Inline camera override for this weapon or tool while it is visibly drawn. FOV and SpringArm SocketOffset are applied when the draw state becomes visible, typically at DrawActiveSet or ApplyCurrentState notifies."))
