...
namespace RpgInventoryManagerRulesPlannerPrivate
{
	...
	FRpgInventoryMutationResult MakeRulesRejectedIntentResult(
	...
	FRpgInventoryMoveIntent Intent) const
{
	...
	if (!IsRulesCompleteSourceSnapshot(
			Intent.ItemId,
		...
		!Intent.TargetPlacement.IsValid())
	{
		return MakeRulesRejectedIntentResult(
			Intent.RequestId,
			ERpgInventoryMutationOperation::Move,
