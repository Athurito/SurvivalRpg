...
namespace RpgGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Rpg_Inventory_Layout_Role_Carry_Primary, "Rpg.Inventory.Layout.Role.Carry.Primary", "Unique primary authored Carry group shown by the player inventory UI.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Rpg_Inventory_Layout_Role_Carry_Secondary, "Rpg.Inventory.Layout.Role.Carry.Secondary", "Unique secondary authored Carry group shown by the player inventory UI.");
